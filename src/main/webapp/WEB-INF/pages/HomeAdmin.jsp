...
<title>Legislations&Policy</title>
<meta charset="utf-8">
					...
					<div class="row">
						<div class="col">
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<li><a href="aorg">Associated Organization</a></li>
								<li><a href="ccharter">Citizen Charter</a></li>
								<li><a href="applicant">View Applicant</a></li>
								<li><a href="oon">Office Order/notice</a></li>
